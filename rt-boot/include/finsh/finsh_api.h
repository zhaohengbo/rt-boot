...
#define __TI_FINSH_EXPORT_VAR(v)       PRAGMA(DATA_SECTION(v,"VSymTab"))
        ...
        #else
            #define FINSH_FUNCTION_EXPORT_CMD(name, cmd, desc)      \
                RT_USED const char __fsym_##cmd##_name[] SECTION(".rodata.name") = #cmd;   \
                RT_USED const char __fsym_##cmd##_desc[] SECTION(".rodata.name") = #desc;  \
            ...
            #define FINSH_VAR_EXPORT(name, type, desc)              \
                RT_USED const char __vsym_##name##_name[] SECTION(".rodata.name") = #name; \
                RT_USED const char __vsym_##name##_desc[] SECTION(".rodata.name") = #desc; \
        ...
        #else
            #define FINSH_FUNCTION_EXPORT_CMD(name, cmd, desc)      		\
                RT_USED const char __fsym_##cmd##_name[] = #cmd;            \
                RT_USED const struct finsh_syscall __fsym_##cmd SECTION("FSymTab")= \
                {                           \
                    __fsym_##cmd##_name,    \
                    (syscall_func)&name     \
            ...
            #define FINSH_VAR_EXPORT(name, type, desc)              		\
                RT_USED const char __vsym_##name##_name[] = #name;          \
                RT_USED const struct finsh_sysvar __vsym_##name SECTION("VSymTab")= \
                {                           \
                    __vsym_##name##_name,   \
                    type,                   \
