...
_READ_WRITE_RETURN_TYPE _EXFUN(read, (int __fd, void *__buf, rt_size_t __nbyte));
_READ_WRITE_RETURN_TYPE _EXFUN(write, (int __fd, const void *__buf, rt_size_t __nbyte));
#else
