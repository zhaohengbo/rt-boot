...
{
    char *buffer;
    rt_size_t length;                      /* content header buffer size */

    rt_size_t size;                        /* maximum support header size */
};
...
struct webclient_session
{
    ...
    int content_length;
    rt_size_t content_remainder;           /* remainder of content length */
...
int webclient_read(struct webclient_session *session, unsigned char *buffer, rt_size_t size);
int webclient_write(struct webclient_session *session, const unsigned char *buffer, rt_size_t size);
