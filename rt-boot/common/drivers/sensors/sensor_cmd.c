...
static void sensor(int argc, char **argv)
{
    ...
    else if (argc == 3)
    {
        ...
        else if (!rt_strcmp(argv[1], "sr"))
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_RANGE, (void *)rt_atoi(argv[2]));
        }
        else if (!rt_strcmp(argv[1], "sm"))
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_MODE, (void *)rt_atoi(argv[2]));
        }
        else if (!rt_strcmp(argv[1], "sp"))
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_POWER, (void *)rt_atoi(argv[2]));
        }
        else if (!rt_strcmp(argv[1], "sodr"))
        {
            rt_device_control(dev, RT_SENSOR_CTRL_SET_ODR, (void *)rt_atoi(argv[2]));
        }
        else
        {
