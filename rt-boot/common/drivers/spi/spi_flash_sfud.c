        ...
        if (!rt_strcmp(operator, "probe")) {
            ...
            if (!rt_strcmp(operator, "read")) {
                if (argc < 4) {
                    ...
                    addr = rt_strtol(argv[2], NULL, 0);
                    size = rt_strtol(argv[3], NULL, 0);
                ...
                if (argc < 4) {
                    ...
                    if (data) {
                        for (i = 0; i < size; i++) {
                            data[i] = rt_strtol(argv[3 + i], NULL, 0);
                        }
                ...
                if (argc < 3) {
                    ...
                    sfud_bool is_volatile = rt_strtol(argv[2], NULL, 0);
                    uint8_t status = rt_strtol(argv[3], NULL, 0);
