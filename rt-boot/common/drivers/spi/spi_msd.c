...
//#include <string.h>
#include <drivers/drivers/spi_msd.h>
...
const static struct rt_device_ops msd_ops SECTION("RTDeviceOps") =
{
    rt_msd_init,
    rt_msd_open,
    rt_msd_close,
...
const static struct rt_device_ops msd_sdhc_ops SECTION("RTDeviceOps") =
{
    rt_msd_init,
    rt_msd_open,
    rt_msd_close,
